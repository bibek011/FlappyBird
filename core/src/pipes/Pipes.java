...
/**
 * Created by TERRORMASTER on 3/17/2018.
 */
...
public class Pipes {
    ...
    private final float DISTANCE_BETWEEN_PIPE=420f;
    ...
    void createPipes(float x, float y){
        ...
        pipe1.setPosition(x, y+DISTANCE_BETWEEN_PIPE);
        pipe2.setPosition(x, y-DISTANCE_BETWEEN_PIPE);
    ...
    public void drawPipes(SpriteBatch batch){
        batch.draw(pipe1, pipe1.getX()-pipe1.getWidth()/2f, pipe1.getY()-pipe1.getHeight()/2f-24);
        batch.draw(pipe2, pipe2.getX()-pipe2.getWidth()/2f, pipe2.getY()-pipe2.getHeight()/2f-14);
    }
